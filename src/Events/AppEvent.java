...
/**
 * Class that recognizes events taken in from other classes and creates new
 * events and acts based on what the event is supposed to do.
 *
...
public class AppEvent extends EventObject {
     ...
     *
     * @param _source - Takes in the name of the Object class the message came
     * from.
